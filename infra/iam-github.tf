...
# Rol de deploy: AdministratorAccess por practicidad (proyecto personal), con la
# confianza OIDC acotada a este repo + rama main. Se puede endurecer más adelante.
